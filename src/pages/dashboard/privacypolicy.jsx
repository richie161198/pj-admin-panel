...
const PrivacyPolicy = () => {
  ...
  const { data: policyResponse, isLoading: isFetching, error: fetchError, refetch } = useGetPolicyByTypeQuery('privacy');
    ...
    if (isFetching) {
      return (
        <div className="flex justify-center items-center h-64">
          <LoadingIcon />
          <p className="ml-3 text-gray-600 dark:text-gray-400">Loading privacy policy...</p>
        </div>
      );
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Manage your privacy policy content and settings</p>
        </div>
      ...
      {activeTab === 'edit' && (
        <div className="space-y-6">
          <Card title="Edit Privacy Policy">
            <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Enter your privacy policy content using Markdown formatting..."
                  required
                />
              </div>
