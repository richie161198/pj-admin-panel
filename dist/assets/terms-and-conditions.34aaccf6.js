import{b as S,r as l,c as t,j as e,L as g,B as c,I as n,C as b,F as h,Q as f}from"./index.cccf3715.js";import{a as P,b as T}from"./utilsApi.21d4532a.js";const A=()=>{const v=S(),[d,i]=l.exports.useState("preview"),{data:r,isLoading:x,refetch:u}=P("terms"),[w,{isLoading:m}]=T(),[s,p]=l.exports.useState({title:"Terms and Conditions",lastUpdated:new Date().toISOString().split("T")[0],content:`# Terms and Conditions
