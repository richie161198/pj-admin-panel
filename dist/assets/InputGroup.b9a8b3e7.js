import{r as q,c as p,j as e,I as m}from"./index.51fda1b3.js";import{C as b}from"./cleave-phone.us.f2a6c368.js";const F=({type:s,label:N,placeholder:i,classLabel:k="form-label",className:a="",classGroup:A="",register:v,name:t,readonly:o,value:B,error:l,icon:C,disabled:u,id:c,horizontal:d,validate:n,isMask:x,description:w,hasicon:I,onChange:f,merged:j,append:h,prepend:$,options:g,onFocus:y,...O})=>{const[r,G]=q.exports.useState(!1),S=()=>{G(!r)};return p("div",{className:`  ${d?"flex":""} 
