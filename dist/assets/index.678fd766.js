import{c as e,j as t,B as n}from"./index.ce738da1.js";import{c as a}from"./code-snippet.919b199b.js";const s=()=>e("div",{className:"space-xy",children:[t(n,{text:"primary",className:"btn-primary "}),t(n,{text:"secondary",className:"btn-secondary"}),t(n,{text:"success",className:"btn-success"}),t(n,{text:"info",className:"btn-info"}),t(n,{text:"warning",className:"btn-warning"}),t(n,{text:"error",className:"btn-danger"}),t(n,{text:"Dark",className:"btn-dark"}),t(n,{text:"Light",className:"btn-light"})]}),o=`
