...
export default BorderBottomTab;`,Oe=`import React, { Fragment } from "react";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
...
export default BorderBottomWithIcon;`,G=[{title:"home",icon:"ph:house-line",content:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent elementum finibus arcu vitae scelerisque. Etiam rutrum blandit condimentum. Maecenas condimentum massa vitae quam interdum, et lacinia urna tempor"},{title:"profile",icon:"ph:user",content:"Pellentesque pulvinar, sapien eget fermentum sodales, felis lacus viverra magna, id pulvinar odio metus non enim. Ut id augue interdum, ultrices felis eu, tincidunt libero."},{title:"messages",icon:"ph:chat-dots",content:"Cras iaculis ipsum quis lectus faucibus, in mattis nulla molestie. Vestibulum vel tristique libero. Morbi vulputate odio at viverra sodales. Curabitur accumsan justo eu libero porta ultrices vitae eu leo."},{title:"settings",icon:"ph:gear-six",content:"Etiam nec ante eget lacus vulputate egestas non iaculis tellus. Suspendisse tempus ex in tortor venenatis malesuada. Aenean consequat dui vitae nibh lobortis condimentum. Duis vel risus est"}],Ue=()=>s("div",{className:"lg:w-7/12",children:w(D,{defaultValue:"home",children:[s(R,{className:" bg-transparent p-0 border-b-2 border-gray-200 rounded-none",children:G.map((e,t)=>s(a.exports.Fragment,{children:s(C,{className:"capitalize   data-[state=active]:bg-transparent data-[state=active]:text-indigo-500 transition duration-150 before:transition-all before:duration-150 relative before:absolute before:left-1/2 before:-bottom-[5px] before:h-[2px] before:-translate-x-1/2 before:w-0 data-[state=active]:before:bg-indigo-500 data-[state=active]:before:w-full",value:e.title,children:e.title})},t))}),G.map((e,t)=>s(a.exports.Fragment,{children:s(F,{value:e.title,children:e.content})},t*32))]})}),O=[{title:"home",icon:"ph:house-line",content:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent elementum finibus arcu vitae scelerisque. Etiam rutrum blandit condimentum. Maecenas condimentum massa vitae quam interdum, et lacinia urna tempor"},{title:"profile",icon:"ph:user",content:"Pellentesque pulvinar, sapien eget fermentum sodales, felis lacus viverra magna, id pulvinar odio metus non enim. Ut id augue interdum, ultrices felis eu, tincidunt libero."},{title:"messages",icon:"ph:chat-dots",content:"Cras iaculis ipsum quis lectus faucibus, in mattis nulla molestie. Vestibulum vel tristique libero. Morbi vulputate odio at viverra sodales. Curabitur accumsan justo eu libero porta ultrices vitae eu leo."},{title:"settings",icon:"ph:gear-six",content:"Etiam nec ante eget lacus vulputate egestas non iaculis tellus. Suspendisse tempus ex in tortor venenatis malesuada. Aenean consequat dui vitae nibh lobortis condimentum. Duis vel risus est"}],je=()=>s("div",{className:"lg:w-7/12",children:w(D,{defaultValue:"home",children:[s(R,{className:" bg-transparent p-0 border-b-2 border-gray-200 rounded-none",children:O.map((e,t)=>s(a.exports.Fragment,{children:w(C,{className:"capitalize   data-[state=active]:bg-transparent data-[state=active]:text-indigo-500 transition duration-150 before:transition-all before:duration-150 relative before:absolute before:left-1/2 before:-bottom-[5px] before:h-[2px] before:-translate-x-1/2 before:w-0 data-[state=active]:before:bg-indigo-500 data-[state=active]:before:w-full",value:e.title,children:[s(be,{icon:e.icon,className:"h-5 w-5 top-[1px] ltr:mr-[6px] rtl:ml-[6px] relative"}),e.title]})},t))}),O.map((e,t)=>s(a.exports.Fragment,{children:s(F,{value:e.title,children:e.content})},t*25))]})}),Qe=()=>w("div",{className:" space-y-5",children:[s(S,{title:"Basic Tabs",code:ke,children:s(Ve,{})}),s(S,{title:"Border Bottom",code:Ge,children:s(Ue,{})}),s(S,{title:"Border Bottom with Icon",code:Oe,children:s(je,{})})]});export{Qe as default};
