import{r as t,c as b,j as e,at as a}from"./index.db93dc89.js";import{c as p}from"./code-snippet.6b7bfbb2.js";const m=()=>{const[i,x]=t.exports.useState(!0),[d,S]=t.exports.useState(!0),[n,C]=t.exports.useState(!0),[r,v]=t.exports.useState(!0),[c,u]=t.exports.useState(!0),[s,g]=t.exports.useState(!0);return b("div",{className:"flex flex-wrap space-xy",children:[e(a,{label:"Default & Primary",value:i,onChange:()=>x(!i)}),e(a,{label:"secondary",activeClass:"bg-fuchsia-500",value:d,onChange:()=>S(!d)}),e(a,{label:"success",activeClass:"bg-green-500",value:n,onChange:()=>C(!n)}),e(a,{label:"danger",activeClass:"bg-red-500",value:r,onChange:()=>v(!r)}),e(a,{label:"warning",activeClass:"bg-yellow-500",value:c,onChange:()=>u(!c)}),e(a,{label:"info",activeClass:"bg-cyan-500",value:s,onChange:()=>g(!s)})]})},y=`
